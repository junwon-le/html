...
<body>
	...
	cursor: pointer;
	font-size: 14px;">예약하기</button>
					<button class="btn2" style="color: #000; border: 1.5px solid #000;
						padding: 8px 20px;
	border-radius: 20px;
	background: transparent;
	cursor: pointer;
	font-size: 14px;">로그인</button>
				</div>
			</div>
			<div id=subBar>
				<div class="close"></div>
		...
		<div class="container">
			...
			<div style="width: 80%; margin: 0px auto;">
				<div style="display: flex;">
					<h3 style="margin-left: 40px;">문의 접수하기</h3>
				</div>

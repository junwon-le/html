...
<div class="page_navi"
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu dropdown-menu-end">
						...
						<li><a href="perform.jsp" style="margin-left: 20px;">행사</a></li>
				...
				<div class="btn-group">
					<button type="button" class="btn btn-secondary dropdown-toggle"
						...
						공연</button>
					<ul class="dropdown-menu dropdown-menu-end">
						<li><a href="http://192.168.10.71/myteam_second_prj/projectttttttttttt/perform.jsp?filter=공연" style="margin-left: 20px;">공연</a></li>
						<li><a href="http://192.168.10.71/myteam_second_prj/projectttttttttttt/perform.jsp?filter=퍼레이드" style="margin-left: 20px;">퍼레이드</a></li>
					</ul>
				</div>
			</div>
			<!-- 미니 메뉴바 끝 -->
    ...
    <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img src="../images/eventimg/${p.perfPreview}" alt="slide1">
                <div class="container">

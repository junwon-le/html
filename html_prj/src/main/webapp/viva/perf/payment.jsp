...
if(memberNumStr == null || memberNumStr.trim().isEmpty()){ memberNumStr = "2"; } 
...
<div class="container">
			<!-- 미니 메뉴바 시작 -->
			<jsp:include page="../include/page_navi.jsp"/>
			<!-- 미니 메뉴바 끝 -->

<!-- 예매화면 -->
<div class="event-main">
  <div class="event-banner" style="background-image:url('../common/images/event.png');">
...
out.println("memberNum=" + request.getParameter("memberNum") + "<br>");
out.println("perfDate=" + request.getParameter("perfDate") + "<br>");
out.println("perfNum=" + request.getParameter("perfNum") + "<br>"); */
%>
        </div>
      </div>
    </div>
...
<input type="text" id="buyerName" class="pay-input" placeholder="이름 입력" name="pResName" maxlength="15">

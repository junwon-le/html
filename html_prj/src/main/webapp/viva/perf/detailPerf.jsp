...
<script type="text/javascript">
  ...
  $(function(){
	...
	function chkNull(){
		const userNum = "<%= session.getAttribute("UserId")==null ? "" : session.getAttribute("UserNum") %>";

		  if(userNum === ""){
		    alert("로그인이 필요합니다.");
		    const returnUrl = encodeURIComponent(location.pathname + location.search);
		    location.href = "loginFrm.jsp?returnUrl=" + returnUrl;
		    return;
		  }
...
<div class="event-main">
  ...
  <div class="event-banner" style="background-image:url('../images/event.png');">
...
<div class="reserve-card">
  <div class="reserve-card-img">
    <img src="../images/eventimg/${p.perfPreview}" alt="뮤지컬 보더라인 포스터">
  </div>

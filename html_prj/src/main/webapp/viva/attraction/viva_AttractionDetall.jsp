...
$(function () {
    ...
    $("#holiday_btn").click(function(){
    	location.href="${CommonURL}/guide/user_guide.jsp";
								...
								<div id="carouselExample" class="carousel slide"  >
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img src="${CommonURL}/images/attr/${DetailData.attracBg}" class="d-block w-100" alt="..." style="border-radius: 20px">
										</div>
										<div class="carousel-item">
											<img src="${CommonURL}/images/attr/${DetailData.attracBg2}" class="d-block w-100" alt="..."style="border-radius: 20px">
										</div>
									</div>

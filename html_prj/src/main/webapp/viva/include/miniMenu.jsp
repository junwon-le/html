...
function miniBtn_Click(name){
	...
	if(name=="acttracBtn"){
		window.location.href="http://localhost/second_prj/attraction/viva_Attraction_main.jsp";
	}else if(name=="foodBtn"){
		
		
		window.location.href="http://localhost/second_prj/restaurant/viva_Restaurant_main.jsp";
	}else if(name=="giftBtn"){
		
		
		window.location.href="http://localhost/second_prj/giftShop/viva_Gift_main.jsp";
					...
					<div class="inner2">
						<div class="breadcrumb__wrap">
							<div class="breadcrumb__home">
								<a class="breadcrumb__home-link" href="/"><span
								...
								<div class="breadcrumbMenu">
									<div class="btn-group">
										...
										<ul class="dropdown-menu dropdown-menu-lg-end">
											...
											<li><button class="dropdown-item" type="button">소통
													서비스</button></li>
										</ul>
									</div>
								</div>

...
<div id="wrap">
	...
	boolean flag = js.searchId(useId);
	String resultMsg = flag ? "이미 사용 중인 아이디입니다.":"사용 가능한 아이디입니다.";
	...
	%>
		...
		<c:choose>
		<c:when test="${!flag}">
		${msg}<form action="http://localhost/html_prj/viva/login/join_Include.jsp?useId=${useId}">

	...
	<div id="mainCarousel" class="carousel slide" data-bs-ride="carousel" style=" z-index:0;">
		...
		<div class="carousel-inner" >
			<div class="carousel-item active" >
				<img src="${CommonURL}/images/bibimtuna.jpg" class="d-block w-100"
					alt="메인 배너1">
					
			</div>
			<div class="carousel-item">
				<img src="${CommonURL}/images/mascots.png" class="d-block w-100"
					alt="메인 배너2">
			</div>
			<div class="carousel-item">
				<img src="${CommonURL}/images/cutiee.png" class="d-block w-100"
					alt="메인 배너3">
			</div>
			<div class="carousel-item">
				<img src="${CommonURL}/images/vivaMainSlide.png" class="d-block w-100"
					alt="메인 배너3">
			</div>
		</div>
